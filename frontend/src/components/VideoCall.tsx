...
//         event.data?.event === "joined-meeting"
//       ) {
//         // Solicita acceso al stream del iframe
//         navigator.mediaDevices.getUserMedia({ audio: true }).then((stream) => {
//           if (onStream) {
//             const clonedStream = stream.clone(); // 👈 SOLUCIÓN CLAVE
//             onStream(clonedStream);
//           }
//         });
//       }
//     };
...
//     return () => window.removeEventListener("message", handleStream);
//   }, [onStream]);
...
// 3. VideoCall.tsx - VERSIÓN SIN DUPLICADOS
"use client";
